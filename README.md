...
[![Build Status](https://github.com/configcat/php-sdk/actions/workflows/php-ci.yml/badge.svg)](https://github.com/configcat/php-sdk/actions/workflows/php-ci.yml)
